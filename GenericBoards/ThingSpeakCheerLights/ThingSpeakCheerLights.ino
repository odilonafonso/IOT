...
int pinBlue = 5;
    ...
    YunClient client;
      ...
      #include <WiFi.h>
      char ssid[] = "PONESA-3G";          //  your network SSID (name) 
      char pass[] = "meiadeseda";   // your network password
...
void setup() {
  ...
  ThingSpeak.begin(client);
   ...
   Serial.println("pinMode(pinRed,OUTPUT)");
      pinMode(pinGreen,OUTPUT);
   Serial.println("pinMode(pinGreen,OUTPUT)");
      pinMode(pinBlue,OUTPUT);
   Serial.println("pinMode(pinBlue,OUTPUT)");
...
void loop() {
  ...
  String color = ThingSpeak.readStringField(cheerLightsChannelNumber, 1);
   Serial.print("ThingSpeak.readStringField(cheerLightsChannelNumber, 1)");
   Serial.print(" color:");Serial.println(color);
  int iColor = setColor(color);

  writeColor(color, iColor);
