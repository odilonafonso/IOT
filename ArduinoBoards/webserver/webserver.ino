...
byte ip[] = {192,168,2,199 }; // This is typically 10.0.0.x

EthernetServer server(81); // Port 80 is http.
...
void SetupSamplePorts()
{
 ...
 pinMode(6,OUTPUT); digitalWrite(6,LOW);  // I use this pin as GND for the LED.
 pinMode(7,OUTPUT); // Sample output, unable to use built-in LED at pin 13 because Ethernet Shield uses pins 10,11,12,13.
}
...
void PrintString(String label, String str)
{
 Serial.print(label);
 Serial.print("=");
 Serial.println(str);
...
void PrintNumber(String label, int number)
{
 Serial.print(label);
 Serial.print("=");
