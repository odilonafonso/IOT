...
#define WEBSERVER_PORT 81
EthernetServer server(WEBSERVER_PORT);

//5100 shield problems when there is a SD card installed
#define SD_SELECT 4
      ...
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          for (int analogChannel = 0; analogChannel < 6; analogChannel++) {
            ...
            int digitalReading = digitalRead(analogChannel+14);
            client.print("analog input ");
            client.print(analogChannel);
            client.print(" is ");
            client.print(sensorReading);
            client.print(" digital ");
            client.print(analogChannel+14);
            client.print(" is ");
