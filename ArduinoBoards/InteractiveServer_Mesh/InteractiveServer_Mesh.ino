...
const byte pinCE = 9; //this pin is used to set nRF24 to standby (0) or active mode (1)
const byte pinCSN = 10; //this pin is used to tell nRF24 whther the SPI communication is a command or message to
