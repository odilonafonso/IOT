...
const int ledPin=9; // lights led on arduino if none attached to pin 
int accesspt=0;

// connect RX,TX on arduino to TX,RX on esp8266
...
//    Serial.println(F("espSerial.available"));
...
//    Serial.println(F("espSerial.available II"));
...
//  waitcmd("thinker.com",10000);
  ...
  msg = F("AT+CWSAP_CUR=\"esp826605\",\"12345678\",1,0,2,0");
...
/*
  Serial.println(F("AT+CWSAP_CUR=\"RobuinoESP8266\",\"12345678\",1,0,2,0"));
  espSerial.println(F("AT+CWSAP_CUR=\"RobuinoESP8266\",\"12345678\",1,0,2,0"));
  waitcmd("OK",1000);
